...
DATA_PATH_TRAIN_FD002_PRUEBA = os.path.join(
    DATA_DIR_FILTRADO, "train_FD002_filtrado.csv"
)
DATA_PATH_TRAIN_FD004_PRUEBA = os.path.join(
    DATA_DIR_FILTRADO, "train_FD004_filtrado.csv"
)
